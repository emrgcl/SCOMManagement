...
PS C:\Source\scripts> .\Get-SCOMRestAlerts.ps1 -ManagementServer $env:COMPUTERNAME -Verbose
VERBOSE: Authentication URL = http://SCOM/OperationsManager/authenticate
VERBOSE: Token from the webssion = SCOM-CSRF-TOKEN=5jtpzpbbqZ9vIkBLM893DR_u6LvWTC-vECiSqMyM3jsi1viQMcXXKgI96EeAn-eMqkmL-5xh-V5RKDdbDwSPhwcUrMf7etptw1emnWt5XwE1%3aN6u7vu4vmiLLjbvMRzpSe-1GE2JgD6yDFScj99-J
vm1q4AIYKMnUW2yOcs8hrTMaeKvq78Mtm5HseMv2sJxdlTnQbE6UW5uYxzTzwUajQFVBPE2_Y1KE2GhXYgJ_6fok0
VERBOSE: POST http://scom/OperationsManager/authenticate with -1-byte payload
...
VERBOSE: POST http://scom/OperationsManager/data/alert with -1-byte payload
VERBOSE: received 4004-byte response of content type application/json; charset=utf-8
VERBOSE: 5 number of alerts returned.


id                          : b1be5c73-6b9b-41c5-a07d-262101c271d3
severity                    : Error
monitoringobjectdisplayname : web01.contoso.com
monitoringobjectpath        : Microsoft.SystemCenter.AgentWatchersGroup
name                        : Health Service Heartbeat Failure
age                         : 99 days, 6 hours
ageinmilliseconds           : 8575607628.8838005
description                 : The System Center Management Health Service on computer web01.contoso.com failed to heartbeat.
owner                       : 
timeadded                   : 2021-01-27T03:29:50.7200000Z
repeatcount                 : 0
netbioscomputername         : 
netbiosdomainname           : 
ismonitoralert              : True

id                          : 140a3f6f-5117-492c-9303-3bf3b18dd2a6
severity                    : Error
monitoringobjectdisplayname : web02.contoso.com
monitoringobjectpath        : Microsoft.SystemCenter.AgentWatchersGroup
name                        : Health Service Heartbeat Failure
age                         : 122 days, 18 hours
ageinmilliseconds           : 10608965278.8838
description                 : The System Center Management Health Service on computer web02.contoso.com failed to heartbeat.
owner                       : 
timeadded                   : 2021-01-03T14:40:32.9670000Z
repeatcount                 : 2
netbioscomputername         : 
netbiosdomainname           : 
ismonitoralert              : True
